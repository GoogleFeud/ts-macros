...
export default function (
    ...
    const transformer = new MacroTransformer(instance.nullTransformationContext, program.getTypeChecker(), macros, instance, options as TsMacrosConfig);
    ...
    for (const sourceFile of program.getSourceFiles()) {
        ...
        console.log(printAsTS(printer, parsed));
