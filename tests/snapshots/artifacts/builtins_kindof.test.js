...
describe("$$kindof", () => {
    it("Expand to the correct node kind", () => {
        (0, chai_1.expect)(208).to.be.equal(typescript_1.default.SyntaxKind.ArrayLiteralExpression);
        (0, chai_1.expect)(218).to.be.equal(typescript_1.default.SyntaxKind.ArrowFunction);
